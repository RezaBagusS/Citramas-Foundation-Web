...
const BannerMission = () => {
  return (
    <div className="relative w-full">
      <h1 className="text-sm md:text-base italic font-bold absolute top-1 md:-top-1 right-1/2 translate-x-1/2 ring-2 ring-custPrimary/30 bg-custPrimary text-custWhite -skew-y-12 rotate-12 px-3 py-1">Our Vison</h1>
