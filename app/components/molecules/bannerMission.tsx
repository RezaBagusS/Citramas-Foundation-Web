...
const BannerMission = () => {
  return (
    <div className="relative w-full">
      <h1 className="text-base italic font-bold absolute -top-1 right-1/2 translate-x-1/2 ring-2 ring-custPrimary/30 bg-custPrimary text-custWhite -skew-y-12 rotate-12 px-3 py-1">Our Mission</h1>
      <div className="grid grid-cols-2 gap-5 px-5 pt-5 pb-10">
